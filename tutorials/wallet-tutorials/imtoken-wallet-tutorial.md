...
Below tutorial will help you understand how to add Zentroscan Coin network RPC on imToken through chainlist.org and transfer/receive tokens on Zentroscan network in imToken wallet.   
...
**Step 4:** Once the Chainlist Dapp is open click on “Connect wallet” at right hand top corner and once the wallet is connected search of “Zentroscan Coin” on the list of EVM networks. Click on “Add to imToken” next to Zentroscan Coin Mainnet and “Approve” the details of Zentroscan Coin RPC on the next step as shown below.
...
**Step 5:** Now you have successfuly added Zentroscan Coin network RPC on imToken wallet. You can now send/receive Zentroscan Coin network assets on imToken wallet.  
