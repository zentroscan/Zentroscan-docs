---
description: ZentroscanSwap API is an auxiliary service to ease the integration with ZentroscanSwap DEX
---

# Zentroscanswap API

## Zentroscanswap Backend API v0.1.0

The Zentroscanswap Backend REST API is used for generating trading data for frontend clients

## PriceChange

### Get price change for token over last 24 hours

[Back to top](https://github.com/Zentroscanio/Zentroscanswap-service/blob/master/docs/api.md#top)
                        ...
                        "tokenAmounts": [
                            {
                                ...
                                "currency": {
                                    "decimals": 6,
                                    "symbol": "USDC",
                                    "name": "USD Coin on Zentroscan Coin",
                                    "chainId": 39656,
                            ...
                            },
                            {
                                ...
                                "currency": {
                                    "decimals": 18,
                                    "symbol": "WETH",
                                    "name": "Wrapped Ether on Zentroscan Coin",
                                    "chainId": 39656,
...
| Name | Type | Description |
| :--- | :--- | :--- |
| methodName | `String` | The method to call on Zentroscanswap RouterV2 |
