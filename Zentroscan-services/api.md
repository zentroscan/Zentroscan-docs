...
## Zentroscan-studio-backend v0.1.0

The Zentroscan Coin Studio REST API for accessing the data and the services of the Zentroscan Coin network in a simple way. You can use this API to query and interact with the objects of the Zentroscan Coin network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and Zentroscan Coin network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(Zentroscan Coin\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the Zentroscan Coin network |
...
| homeBridgeAddress | `String` | Bridge address on the Zentroscan Coin network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the Zentroscan Coin network |
...
Community is a set of contracts and services. Members of the community are users of the Zentroscan Coin network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the Zentroscan Coin network |
| homeTokenAddress | `String` | Address of the community token on the Zentroscan Coin network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the Zentroscan Coin network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the Zentroscan Coin network |
...
Entity is an account on the Zentroscan Coin network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on Zentroscan Coin network |
...
Tokens are compatible with the Zentroscan20 standard, and they also can be burnable/mintable. Tokens are an important part of the community economy.
...
| networkType | `String` | Network type where the token is issued: mainnet/ropsten/Zentroscan |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| networkType | `String` | mainnet/ropsten/Zentroscan |
| page | `Number` | Page number for pagination |
