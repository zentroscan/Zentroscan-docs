---
description: Steps on deploying a smart contract on Zentroscannet through Remix.
---

# Deploying smart contract on Zentroscannet

Zentroscan Coin is an EVM compatible network, every tool for Ethereum can be used for the Zentroscan Coin network too.
...
Since we interact with remix using Metamask, you need to change the network to Zentroscan Coin network by adding a custom RPC. Please follow the steps in [this tutorial](https://docs.Zentroscan.com/the-Zentroscan-studio/getting-started/how-to-add-Zentroscan-to-your-metamask) to do that.

You need to have a small balance of Zentroscan on the Zentroscannet wallet you are using which will be used as Gas for the transactions.
