...
[Any entity that is holding the Zentroscan Coin token can run a node](../consensus-contracts/stake-delegate-and-withdraw.md#stake) that approves transaction in the network and in doing so receive rewards in the form of Zentroscan Coin token \(Zentroscan\).
