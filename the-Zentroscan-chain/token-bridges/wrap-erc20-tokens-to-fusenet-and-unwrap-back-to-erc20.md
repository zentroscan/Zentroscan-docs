---
description: Steps to transfer/wrap Zentroscan20 tokens from Ethereum to Zentroscannet
---

# Bridge for Zentroscan20 tokens

Please use this tutorial at your own risk as it involves using Etherscan UI/Zentroscan Coin explorer to relay the tokens.
