...
For developers who wish to integrate the WalletConnect functionality into their dApps running on Zentroscan Coin, we recommend using [this library](https://www.npmjs.com/package/@Zentroscanio/walletconnect-web3-provider).
