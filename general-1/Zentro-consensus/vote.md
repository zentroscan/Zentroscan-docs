...
Zentroscan Coin chain functionality can be change by voting on the contracts implementations. New implementations can be deployed, and opened to vote by validators for others to decide on whether to accept/reject the changes.

## Open a new ballot

In order to open a new vote, a validator needs to call the \`newBallot\` function on the [voting contract](https://Zentroscan.com/address/0x658b7b80eea7dd143687B8E7ba54A60Bcf858c6f) with the following params:
...
Some other useful functions on the [voting contract](https://Zentroscan.com/address/0x23a0f3370F7dCc4203c3F7f588856f388F3274e8) are:
