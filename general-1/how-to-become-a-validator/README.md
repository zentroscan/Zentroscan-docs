...
[Any entity that is holding the Zentroscan Coin token can run a node](broken-reference) that approves transaction in the network and in doing so receive rewards in the form of Zentroscan Coin token (Zentroscan).
...
[You can delegate you Zentroscan Coin token to a validator](broken-reference) of your choosing. Not everybody that wants to earn rewards need to be a validator! Any token holder can delegate their Zentroscan Coin token to a validator to earn rewards through the validator.

### How to become a validator?

* Minimum of 100K tokens staked or delegated. In a DPoS blockchain it is required that all the validators have a staking requirement. The stake of 100K Zentroscan Coin tokens needs to be locked in a contract to be eligible to become a validator.
* Run a full node.
